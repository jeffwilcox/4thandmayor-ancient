...
{
    // Please can I just start using RestSharp already or something like that?
    ...
    public class FourSquareWebClient : WebRequestClient
    {
        ...
        public override WebClient GetWrappedClientTemporary()
        {
            var client = base.GetWrappedClientTemporary();
            client.Headers["UserAgent"] = ClientInformation;
            return client;
        }
        ...
        public static Uri CreateServiceRequest(Uri uriBeforeAuth, bool? useCredentials = null)
        {
            EnsureCredentials();
...
//            bool auth = false;
        ...
        public class UriErrorPair
        {
            ...
            public UriErrorPair(Uri uri, Exception error) : this(uri)
            {
                Error = error;
            }
        }
