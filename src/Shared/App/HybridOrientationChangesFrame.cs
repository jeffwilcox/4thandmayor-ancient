...
//
// NOTE:
// This file is currently marked with a Build Action of 'None' and is not 
...
namespace Delay
{
    ...
    public class HybridOrientationChangesFrame : TransitionFrame
    {
        ...
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register("Duration", typeof(TimeSpan), typeof(HybridOrientationChangesFrame), new PropertyMetadata(TimeSpan.FromSeconds(4.4)));
        ...
        private void HandleStoryboardCompleted(object sender, EventArgs e)
        {
            ...
            Application.Current.GetFrame().OverlayGrid.Children.Remove(grid);
        }
    }
}
