...
// Fixes bugs going to the negative versions of the file.
...
namespace Microsoft.Phone.Controls.Primitives
{
    ...
    public class RelativeAnimatingContentControl : ContentControl
    {
        ...
        private abstract class GeneralAnimationValueAdapter<T> : AnimationValueAdapter
        {
            ...
            {
                // XXXXX: Need to validate this one........
                //double floor = Math.Floor(number);
                double floor = Math.Round(number);
                double remainder = Math.Abs(number - floor);
