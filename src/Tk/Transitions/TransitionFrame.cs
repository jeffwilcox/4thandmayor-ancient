...
namespace Microsoft.Phone.Controls
{
    ...
    public class TransitionFrame : PhoneApplicationFrame
    {
        ...
        private void OnNavigating(object sender, NavigatingCancelEventArgs e)
        {
            ...
            var asTransitionElement = oldElement as ITransitionCompleted; // temp
            if (asTransitionElement != null)
            {
                asTransitionElement.OnTransitionGoodbyeTemporary();
            }
        ...
        private void TransitionNewContent(ITransition newTransition, NavigationInTransition navigationInTransition)
        {
            ...
            Transition asTransition = newTransition as Transition;
            if (asTransition != null && asTransition.Element != null)
            {
                ITransitionCompleted itc = asTransition.Element as ITransitionCompleted;
                if (itc != null)
                {
                    /*System.Diagnostics.Debug.WriteLine("***  ");
                    System.Diagnostics.Debug.WriteLine("*** OnTransitionCompleted()");
                    System.Diagnostics.Debug.WriteLine(" ");*/
                    itc.OnTransitionCompleted();
                }
            }
